...
namespace NEWTEST
{
    class Program
    {
        ...
        static RectangleShape rectbl1, rectbl2;
        ...
        static byte red = 140;
        static byte green = 140;
        static byte blue = 140;
        ...
        static void TextInGame()
        {
            string help = "press 'h' for help";
            Text Thelp = new Text(help, Arial, 50);
            Thelp.Position = new Vector2f(830, 15);
            Thelp.DisplayedString = help;
            window.Draw(Thelp);
